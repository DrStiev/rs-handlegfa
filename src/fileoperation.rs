...
pub fn save_as_gfa2_file(
    ...
    let path = path.unwrap_or(String::from("./tests/output_files/default_path/file_gfa2.gfa"));
...
pub fn save_as_gfa1_file(
    ...
    let path = path.unwrap_or(String::from("./tests/output_files/default_path/file_gfa1.gfa"));
    let path = Path::new(&path);
    let mut file = File::create(path)?;
...
mod tests {
    ...
    fn can_save_handlegraph_as_gfa2_file() {
        ...
        match save_as_gfa2_file(&graph, Some(String::from("./tests/output_files/file_gfa2.gfa"))) {
    ...
    fn can_save_handlegraph_as_gfa1_file() {
        ...
        // save file on a specific path 
        match save_as_gfa1_file(&graph, Some(String::from("./tests/output_files/file_gfa1.gfa"))) {
            Ok(_) => println!("Handlegraph saved correctly!"),
            Err(why) => println!("Error: {}", why), 
        };
    }
    ...
    fn can_use_file_gfa2_saved() {
        ...
        let gfa2: GFA2<BString, OptionalFields> = parser.parse_file("./tests/output_files/file_gfa2.gfa").unwrap();
    ...
    fn can_use_file_gfa1_saved() {
        ...
        let gfa: GFA<BString, OptionalFields> = parser.parse_file("./tests/output_files/file_gfa1.gfa").unwrap();
